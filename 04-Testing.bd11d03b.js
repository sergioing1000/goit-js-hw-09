...
})({"3iWsA":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "e18b623dbd11d03b";
"use strict";
...
},{}],"lWEUE":[function(require,module,exports) {
...
createPromisesButton.addEventListener("click", function(event) {
    ...
    setTimeout(function() {
        executePromises(amountValue, delayStepValue).then(()=>{
...
async function executePromises(nveces, delayStepValue) {
    if (nveces > 0) for(let i = 1; i <= nveces; i++)await createPromise(i, delayStepValue);
}
function createPromise(i, delayS) {
    return new Promise((resolve)=>{
        setTimeout(()=>{
            ...
            if (shouldResolve) (0, _notiflixDefault.default).Notify.info(`PROMESA No. ${i} :  RESUELTA`);
            else (0, _notiflixDefault.default).Notify.failure(`PROMESA No. ${i} NO SE RESOLVIO.`);
            resolve();
        }, delayS);
    });
}
...
},{}]},["3iWsA","lWEUE"], "lWEUE", "parcelRequire7bc7")

//# sourceMappingURL=04-Testing.bd11d03b.js.map
