...
})({"1Z8yg":[function(require,module,exports) {
...
createPromisesButton.addEventListener("click", function(event) {
    ...
    setTimeout(function() {
        if (amountValue > 0) for(let i = 1; i <= amountValue; i++)setTimeout(()=>{
...
function createPromise(iteracion, delayS) {
    ...
    if (shouldResolve) (0, _notiflixDefault.default).Notify.info(`PROMESA No. ${iteracion} :  RESUELTA`);
    else (0, _notiflixDefault.default).Notify.failure(`PROMESA No. ${iteracion} NO SE RESOLVIO.`);
...
},{}]},["1Z8yg","8tzFL"], "8tzFL", "parcelRequire7bc7")
